...
public class WebLinkListener implements HyperlinkListener{
	...
	/**
	 * HyperlinkListener for the Body Part Panel
	 ...
	 * @param backURL Stack for the History
	 */

    public WebLinkListener(
	...
	public void hyperlinkUpdate(HyperlinkEvent hyperlinkEvent) {
        if (hyperlinkEvent.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
            try {
                String prevURL = bodyPane.getPage().toString();
                String nextURL = hyperlinkEvent.getURL().toString();
